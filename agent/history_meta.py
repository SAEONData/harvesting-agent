"""
Provides transparent versioning of SQLAlchemy ORM objects, storing records to history tables for each change.

Copied from https://docs.sqlalchemy.org/en/latest/_modules/examples/versioned_history/history_meta.html
with modifications indicated by comments.

See also https://docs.sqlalchemy.org/en/latest/orm/examples.html#versioning-objects
"""
...
# Added by MJ
def _is_nonversioned_col(col):
    return "not_versioned" in col.info
...
def _history_mapper(local_mapper):
    ...
    if not super_mapper or \
        ...
        for column in local_mapper.local_table.c:
            ...
            # Added by MJ
            if _is_nonversioned_col(column):
                continue
...
def create_version(obj, session, deleted=False):
    ...
    for om, hm in zip(
        ...
        for hist_col in hm.local_table.c:
            ...
            # Added by MJ
            if _is_nonversioned_col(hist_col):
                continue
